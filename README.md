...
> 展開後、デスクトップに `fy27-aws-handson-main` などのフォルダが作成されます。  
...
| 会員登録確認画面（管理者向け） | http://fy27-suzuki-tetsuya-admin.s3-website-ap-northeast-1.amazonaws.com/ |
...
| 項目 | 値 |
|------|-----|
| バケット名 | <font color="red">fy27-lastname-firstname</font> |
...
| 項目 | 値 |
|------|-----|
| 関数名 | <font color="red">users-post-function-fy27-lastname-firstname</font> |
| ランタイム | Python 3.12 |
| 実行ロール | 既存のロールを使用 → <font color="red">fy27-lastname-firstname</font> |
...
|------|-----|
| APIタイプ | REST API |
| API名 | <font color="red">fy27-lastname-firstname-b</font> |
| リソース名 | <font color="red">fy27-lastname-firstname-b</font> |
